...
@Component({
  selector: 'app-find-schedule-student',
  templateUrl: './find-schedule-student.component.html',
  styleUrls: ['./find-schedule-student.component.css']
})
export class FindScheduleStudentComponent implements OnInit {
      ...
      payments.forEach(paymentRequest => {
        ...
        if (request) {
          ...
          this.scheduleService.getSchedule(idSchedule).subscribe((schedule: Schedule) => {
            console.log('user extraido ' , schedule)
